...
func NewBatchUpload(trans *TransactionData, config *Config) (*BatchUploadTransaction, error) {
	fieldMap := map[EntryMode][]uint8{
		INSERT:   {0, 2, 3, 4, 11, 12, 13, 14, 22, 24, 25, 37, 38, 39, 41, 42, 62},
		SWIPE:    {0, 2, 3, 4, 11, 12, 13, 14, 22, 24, 25, 37, 38, 39, 41, 42, 62},
		WAVE:     {0, 2, 3, 4, 11, 12, 13, 14, 22, 24, 25, 37, 38, 39, 41, 42, 62},
	...
	case KindSale:
		trxn.processingCode = "00000"
	case KindVoidSale:
		trxn.processingCode = "02000"
	case KindRefund:
		trxn.processingCode = "00000"
	case KindVoidRefund:
		trxn.processingCode = "00000"
	...
	if trans.TransType == KindBatchUploadLast {
		lastFlag = "0"
	}

	trxn.processingCode += lastFlag
